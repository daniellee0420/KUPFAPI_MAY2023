            ...
            try
            {
               ...
               var data = new VoucherDtoListObj();
                ...
                using (SqlConnection connection = new SqlConnection(CommonMethods.GetDbConnection()))
                {
                    ...
                    {
                        data.VoucherDto = voucherList.Where(a => a.EnglishName.ToUpper().Contains(paginationParams.Query.ToUpper()) || a.ArabicName.ToUpper().Contains(paginationParams.Query.ToUpper()) ||
             ...
             //   data.VoucherDto.AddRange(filterdata);
                return data;
            }
            catch (Exception ex)
            {
