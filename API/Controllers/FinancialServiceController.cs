...
namespace API.Controllers
{
    ...
    public class FinancialServiceController : ControllerBase
    {
        ...
        public async Task<PagedList<ReturnTransactionHdDto>> GetEmployees([FromQuery] PaginationModel paginationModel)
        {
            var result = await _financialService.GetFinancialServiceAsync(paginationModel);
